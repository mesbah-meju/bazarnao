...
function addaccountcontra(divName) {
    ...
    if (count == limits)
        ...
        newdiv.innerHTML =
            ...
            count +
            "' class='form-control' ></select></td><td><input type='text' name='txtComment[]' value='' class='form-control'  id='txtComment_" +
            count +
            "' ></td><td><input type='number' name='txtAmount[]' class='form-control total_price text-right' value='' placeholder='0.00' id='txtAmount_" +
            count +
            "' onkeyup='calculationcontra(" +
            count +
            ")'></td><td><input type='number' name='txtAmountcr[]' class='form-control total_price1 text-right' id='txtAmount1_" +
            count +
            "' value='' placeholder='0.00' onkeyup='calculationcontra(" +
            count +
            ")'></td><td><button  class='btn btn-danger red' type='button' value='delete' onclick='deleteRowcontra(this)'><i class='fa fa-trash-o'></i></button></td>";
...
function addaccountcontra2(divName) {
    ...
    if (count == limits)
        ...
        newdiv.innerHTML =
            "<td> <select name='cmbCode[]' id='cmbCode_" +
            count +
            "' class='form-control' onchange='load_codecontra(this.value," +
            count +
            ")'></select></td><td><input type='text' name='txtCode[]' class='form-control'  id='txtCode_" +
            count +
            "' ></td><td><input type='number' name='txtAmount[]' class='form-control total_price text-right' value='' placeholder='0.00' id='txtAmount_" +
            count +
            "' onkeyup='calculationcontra(" +
...
function addaccountCreditv(divName) {
    ...
    if (count == limits)
        ...
        newdiv.innerHTML =
            "<td> <select name='cmbCode[]' id='cmbCode_" +
            count +
            "' class='form-control' onchange='load_subtypeOpen(this.value," +
            count +
            ")'></select></td><td><select name='subtype[]' id='subtype_" +
            count +
            "' class='form-control' ><option value=''>Please select One</option></select></td><td><input type='hidden' name='isSubtype[]' id='isSubtype_" +
            count +
            ...
            count +
            "' onkeyup='calculationCreditv(" +
            count +
            ")'></td><td><button  class='btn btn-danger red' type='button' value='delete' onclick='deleteRowCreditv(this)'><i class='fa fa-trash-o'></i></button></td>";
        document.getElementById(divName).appendChild(newdiv);
        $("#cmbCode_" + count).html(optionval);
        $("#subtype_" + count).attr("disabled", "disabled");
        document.getElementById(tabin).focus();
...
function addaccountCreditv2(divName) {
    ...
    if (count == limits)
        ...
        newdiv.innerHTML =
            "<td> <select name='cmbCode[]' id='cmbCode_" +
            count +
            "' class='form-control' onchange='load_codeCreditv(this.value," +
            count +
            ")'></select></td><td><input type='text' name='txtCode[]' class='form-control'  id='txtCode_" +
            count +
            "' ></td><td><input type='number' name='txtAmount[]' class='form-control total_price text-right' id='txtAmount_" +
...
function addaccountDebt(divName) {
    ...
    if (count == limits)
        ...
        newdiv.innerHTML =
            ...
            "' ></td><td><input type='number' name='txtAmount[]' class='form-control total_price text-right' id='txtAmount_" +
            count +
            "' onkeyup='calculationDebtv(" +
            count +
            ")'></td><td><button  class='btn btn-danger red' type='button' value='delete' onclick='deleteRowDebtv(this)'><i class='fa fa-trash-o'></i></button></td>";
        document.getElementById(divName).appendChild(newdiv);
        $("#cmbCode_" + count).html(optionval);
        $("#subtype_" + count).attr("disabled", "disabled");
        document.getElementById(tabin).focus();
...
function addaccountOpen(divName) {
    ...
    if (count == limits)
        ...
        newdiv.innerHTML =
            ...
            ")'></select></td><td><select name='subtype[]' id='subtype_" +
            count +
            "' class='form-control' ><option value=''>Please select One</option></select></td><td><input type='number' name='txtDebit[]' class='form-control total_dprice text-right' id='txtDebit_" +
            count +
            ...
            count +
            "'  value='1'/></td><td><button  class='btn btn-danger red' type='button' value='delete' onclick='deleteRowDebtOpen(this)'><i class='fa fa-trash-o'></i></button></td>";
        document.getElementById(divName).appendChild(newdiv);
        $("#cmbCode_" + count).html(optionval);
        $("#subtype_" + count).attr("disabled", "disabled");
        document.getElementById(tabin).focus();
...
function addaccountJournalv(divName) {
    ...
    if (count == limits)
        ...
        newdiv.innerHTML =
            ...
            count +
            "' class='form-control'></select></td><td><button  class='btn btn-danger red' type='button' value='delete' onclick='deleteRowJournalv(this)'><i class='fa fa-trash-o'></i></button></td>";
        document.getElementById(divName).appendChild(newdiv);
        $("#cmbCode_" + count).html(optionval);
...
function addaccountJournalv2(divName) {
    ...
    if (count == limits)
        ...
        newdiv.innerHTML =
            "<td> <select name='cmbCode[]' id='cmbCode_" +
            count +
            "' class='form-control' onchange='load_codeJournalv(this.value," +
            count +
            ")'></select></td><td><input type='text' name='txtCode[]' class='form-control'  id='txtCode_" +
            count +
            "' ></td><td><input type='number' name='txtAmount[]' class='form-control total_price text-right' value='' placeholder='0.00' id='txtAmount_" +
            ...
            "' value='' placeholder='0.00' onkeyup='calculationJournalv(" +
            count +
            ")'></td><td><button  class='btn btn-danger red' type='button' value='delete' onclick='deleteRowJournalv(this)'><i class='fa fa-trash-o'></i></button></td>";
        document.getElementById(divName).appendChild(newdiv);
        document.getElementById(tabin).focus();
        $("#cmbCode_" + count).html(optionval);
        count++;
...
function isFixedAssetSch_change(fxas, ht) {
    if ($("#" + fxas).is(":checked")) {
        if (ht == "A") {
            var fixedcode =
                '<td>Fixed Asset Code</td><td><input type="text" name="assetCode" id="assetCode" class="form_input" onchange="enableDisableField(\'assetCode\',\'depCode\')" value=""/></td>';
            var depraciationcode =
                '<td>Depraciation Rate % </td><td><input type="text" name="DepreciationRate" id="DepreciationRate" class="form_input"  value=""/></td>';
        } else {
            ...
            var fixedcode = "";
            var depraciationcode =
                '<td>Depraciation Code</td><td><input type="text" name="depCode" id="depCode" class="form_input"  onchange="enableDisableField(\'depCode\',\'assetCode\')" value=""/></td>';
        }
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (headlabel == 3) {
                ...
                if (
                    data.rowdata.HeadType == "A" ||
                    data.rowdata.HeadType == "L"
                ) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status == "success") {
                    ...
                    alert(
                        "You can not delete this account because some transation being occure related this account!"
                    );
                }
            },
            error: function (jqXHR, textStatus, errorThrown) {
