...
function addaccountCreditv(divName) {
    var row = $("#creditAccVoucher tbody tr").length;
    ...
    if (count == limits)
        ...
        newdiv.innerHTML =
            ...
            count +
            "' class='form-control aiz-selectpicker' onchange='load_subtypeCreditv(this.value," +
            count +
            ...
            count +
            ")'></td><td><button  class='btn btn-danger red' type='button' value='delete' onclick='deleteRowCreditv(this)'><i class='las la-trash'></i></button></td>";
...
function deleteRowCreditv(e) {
    var t = $("#creditAccVoucher > tbody > tr").length;
