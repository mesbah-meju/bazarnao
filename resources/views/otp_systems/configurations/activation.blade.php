    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'otp_for_order')" @if(\App\Models\OtpConfiguration::where('type', 'otp_for_order')->first()->value == 1) checked @endif>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'otp_for_delivery_status')" @if(\App\Models\OtpConfiguration::where('type', 'otp_for_delivery_status')->first()->value == 1) checked @endif>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input type="checkbox" onchange="updateSettings(this, 'otp_for_paid_status')" @if(\App\Models\OtpConfiguration::where('type', 'otp_for_paid_status')->first()->value == 1) checked @endif>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
