            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{ uploaded_asset($brand->logo) }}" alt="{{ __('Brand') }}" class="h-50px">
                        </td>
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{ route('brands.edit', ['id'=>$brand->id, 'lang'=>config('app.default_locale')]) }}" title="{{ __('Edit') }}">
