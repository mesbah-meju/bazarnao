        ...
        <tbody>
            @foreach ($product_ids as $key => $id)
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" placeholder="{{ translate('Web Quantity') }}" name="web_quantity[{{ $id }}]" class="form-control quantity web-quantity small-font" data-id="{{ $id }}" data-price="{{ $product->unit_price }}" required onchange="updateBasePrice(this, 'web')">
                    </td>
                    <td>
                        <input type="number" placeholder="{{ translate('Web Total Price') }}" name="web_base_price[{{ $id }}]" class="form-control base-price web-base-price small-font" data-id="{{ $id }}" readonly>
                    </td>
                    <td>
                        <input type="number" placeholder="{{ translate('Web Discount') }}" name="web_discount_price[{{ $id }}]" class="form-control discount-price web-discount-price small-font" data-id="{{ $id }}" required onchange="updateDiscountAmount(this, 'web')">
                    </td>
                    <td>
                    ...
                    <td>
                        <input type="number" placeholder="{{ translate('Web Price After Discount') }}" name="web_price[{{ $id }}]" class="form-control total-price web-total-price small-font" data-id="{{ $id }}" readonly>
                    </td>
                    <td>
                        <input type="number" placeholder="{{ translate('App Quantity') }}" name="app_quantity[{{ $id }}]" class="form-control quantity app-quantity small-font" data-id="{{ $id }}" data-price="{{ $product->unit_price }}" required onchange="updateBasePrice(this, 'app')">
                    </td>
                    <td>
                        <input type="number" placeholder="{{ translate('App Total Price') }}" name="app_base_price[{{ $id }}]" class="form-control base-price app-base-price small-font" data-id="{{ $id }}" readonly>
                    </td>
                    <td>
                        <input type="number" placeholder="{{ translate('App Discount') }}" name="app_discount_price[{{ $id }}]" class="form-control discount-price app-discount-price small-font" data-id="{{ $id }}" required onchange="updateDiscountAmount(this, 'app')">
                    </td>
                    <td>
                    ...
                    <td>
                        <input type="number" placeholder="{{ translate('App Price After Discount') }}" name="app_price[{{ $id }}]" class="form-control total-price app-total-price small-font" data-id="{{ $id }}" readonly>
                    </td>
                </tr>
            @endforeach
        </tbody>
...
<script>
    function updateBasePrice(element, type) {
        ...
        if (!isNaN(price) && !isNaN(quantity)) {
            ...
            // Update total price if discount price is already entered
    ...
    function updateDiscountFields(select, type) {
        ...
        // Recalculate total price based on new discount type
    ...
    function updateDiscountAmount(input, type) {
        ...
        // Update total price based on discount price change
