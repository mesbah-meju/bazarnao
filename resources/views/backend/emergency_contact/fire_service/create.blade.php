    	...
    	<div class="row align-items-center">
    		<div class="col-md-12">
                <div class="card-header d-flex justify-content-between">
    				...
    				<a class="btn btm-sm btn-primary p-1" href="{{ route('fire_service.index') }}" role="button">Police Station Contact List</a>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header">
                        <h2>{{ __('Add Fire Service Contact') }}</h2>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('fire_service.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="duration_hours" id="duration_hours" class="form-control" >
                            </div>
                            <div class="form-group">
