    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <!-- Accounts -->
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)) || in_array('122', json_decode(Auth::user()->staff->role->permissions)))
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <!-- <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('account.coa_list') }}" class="aiz-side-nav-link">
                                    {{-- <a href="#" class="aiz-side-nav-link"> --}}
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('chart-of-accounts.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">COA Tree Views</span>
                                    </a>
                                </li>
                            </ul>
                        </li> -->
                        @if(Auth::user()->user_type == 'admin' || (isset(Auth::user()->staff) && Auth::user()->staff->role?->name != 'Account Executive'))
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('chart-of-accounts.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Chart of Account') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('sub-accounts.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Sub Account List') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('predefined.accounts.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Predefined Accounts') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('financial-years.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Financial Year') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('opening-balances.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Opening Balance') }}</span>
                            </a>
                        </li>
                        @endif
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('debit-vouchers.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Debit Voucher') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('credit-vouchers.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Credit Voucher') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('contra-vouchers.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Contra Voucher') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('journal-vouchers.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Journal Voucher') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('bank-reconciliation.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Bank Reconciliation') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="javascript:void(0);" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Bank & Loan') }}</span>
                                <span class="aiz-side-nav-arrow"></span>
                            </a>
                            <ul class="aiz-side-nav-list level-3">
                                <li class="aiz-side-nav-item">
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('loans.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Loans') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('cash-transfers.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Cash Transfer') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('supplier-payment.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Supplier Payment') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customer-receive.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Customer Receive') }}</span>
                            </a>
                        </li>
                        @if(Auth::user()->user_type == 'admin' || (isset(Auth::user()->staff) && Auth::user()->staff->role?->name != 'Account Executive'))
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('vouchers.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Voucher Approval') }}</span>
                            </a>
                        </li>
                        @endif
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('cash-book.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['cash-book.index', 'cash-book-report.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Cash Book') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('bank-book.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['bank-book.index', 'bank-book-report.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Bank Book') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('day-book.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['day-book.index', 'day-book-report.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Day Book') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('general-ledger.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['general-ledger.index', 'general-ledger.report', 'general-ledger.print']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('General Ledger') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('sub-ledger.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['sub-ledger.index', 'sub-ledger.report']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Sub Ledger') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('trial-balance.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['trial-balance.index', 'trial-balance-report.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Trial Balance') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('income-statement.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['income-statement.index', 'income-statement-report.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Income Statement (Monthly)') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('income-statement-yearly-report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['income-statement-yearly-report.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Income Statement (Yearly)') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('expenditure-statement.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['expenditure-statement.index', 'expenditure-statement-report.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Expenditure Statement') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('profit-loss.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['profit-loss.index', 'profit-loss.report']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Profit Loss') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('balance-sheet.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Balance Sheet') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('fixed-asset.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['fixed-asset.index', 'fixed-asset-report.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Fixed Asset Schedule') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('receipt-payment.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['receipt-payment.index', 'receipt-payment-report.report']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Receipt & Payment') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('bank-reconciliation.report') }}" class="aiz-side-nav-link {{ areActiveRoutes(['bank-reconciliation.report']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Reconciliation Report') }}</span>
                                    </a>
                                </li>
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('account.coa_print') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Print Chart of Accoutns') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('warehouse.index')}}"  class="aiz-side-nav-link {{ areActiveRoutes(['warehouse.index'])}}">
                                <span class="aiz-side-nav-text">{{translate('All Warehouse')}}</span>
                            </a>
                        </li>
                        @endif
                        @if(Auth::user()->user_type == 'admin' || in_array('22', json_decode(Auth::user()->staff->role->permissions)))
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('32', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('suppliers.coa') }}" class="aiz-side-nav-link {{ areActiveRoutes(['purchase', 'purchase'])}}">
                                <span class="aiz-side-nav-text">{{translate('Supplier Coa')}}</span>
                            </a>
                        </li>
                        @endif
                        @if(Auth::user()->user_type == 'admin' || in_array('32', json_decode(Auth::user()->staff->role->permissions)))
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customers.coa') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Customers COA') }}</span>
                            </a>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{route('sellers.coa')}}" class="aiz-side-nav-link {{ areActiveRoutes(['sellers.coa']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Sellers COA') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @if(Auth::user()->user_type == 'admin' || in_array('26', json_decode(Auth::user()->staff->role->permissions)))
                                <li class="aiz-side-nav-item mx-2">
                                    <a href="{{ route('product_fifo_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['product_fifo_report.index'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Fifo Sales History') }}</span>
                                    </a>
                                </li>
                                @endif
                                @if(Auth::user()->user_type == 'admin' || in_array('26', json_decode(Auth::user()->staff->role->permissions)))
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('27', json_decode(Auth::user()->staff->role->permissions)) || Auth::user()->staff->role->name == 'Account Executive' || Auth::user()->staff->role->name == 'Account Manager')
                        <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('happy_hours.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['flash_deals.index'])}}">
                                <span class="aiz-side-nav-text">{{ translate('Happy Hour') }}</span>
                            </a>
                        </li>
                        @endif
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('staffs.coa') }}" class="aiz-side-nav-link {{ areActiveRoutes(['staffs.index', 'staffs.create', 'staffs.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Staffs Coa')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
