                ...
                <table class="table table-striped aiz-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ ini_get('max_execution_time') == '-1' ? 'Unlimited' : ini_get('max_execution_time') }}</td>
                            <td>600+</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>{{ ini_get('max_input_time') == '-1' ? 'Unlimited' : ini_get('max_input_time') }}</td>
                            <td>120+</td>
                            <td>
                        ...
                        <tr>
                            <td>memory_limit</td>
                            <td>{{ ini_get('memory_limit') == '-1' ? 'Unlimited' : ini_get('memory_limit') }}</td>
                            <td>256M+</td>
                            <td>
                                @php
