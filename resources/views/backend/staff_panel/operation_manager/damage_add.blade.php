...
@section('content')
    <div class="row gutters-10">
        <div class="col-lg-12">
            ...
            <div class="">
        <form class="form form-horizontal mar-top" action="{{route('damage.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
            @csrf
            <input type="hidden" name="added_by" value="admin">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Damage Entry')}}</h5>
                </div>
                <div class="card-body">
                <div class="col-md-6 pull-left">
                    ...
                    <div class="col-md-6 pull-left">
                        <label>{{translate('Damage Total Amount')}} <span class="text-danger">*</span></label>

                        <input type="number" class="form-control" name="total_amount" id="total_amount" placeholder=""  required>
