	...
	<div class="row align-items-center">
        ...
        @if($type != 'Seller')
    		<div class="col text-right">
    			<a href="{{ route('cutomerservice_add_product.index')}}" class="btn btn-circle btn-info">
                ...
                @foreach($products as $key => $product)
                    <tr>
						...
						<td class="text-right">
							...
							@else
								<a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('staff_product_edit.index', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
								   <i class="las la-edit"></i>
							   </a>
							@endif
