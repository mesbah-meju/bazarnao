...
@section('content')
                    ...
                    <address>
                        @php
                            if (empty($order->guest_id)) {
                                $area_info = \App\Models\Customer::join(
                                    'areas',
                                    'areas.code',
                                    '=',
                                    'customers.area_code',
    ...
    <div class="modal fade" id="cancel-modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-zoom" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" id="save_payment" onclick="save_cancel_reson()"
                        class="btn btn-primary">{{ translate('Save') }}</button>
                </div>
            </div>
        </div>
