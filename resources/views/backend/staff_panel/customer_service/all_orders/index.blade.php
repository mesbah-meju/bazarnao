        ...
        <div class="card-header row gutters-5">
          ...
          <div class="col-lg-2 ml-auto">
                <select class="form-control aiz-selectpicker" name="warehouse_id" id="warehouse_id"> 
                   ...
                   <option <?php if($warehouse_id == $warehouse->id ) echo 'selected';?> value="{{$warehouse->id}}">{{$warehouse->name}}</option>
                   @endforeach
                </select>
            </div>
          <div class="col-lg-2 ml-auto">
        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    <th data-breakpoints="md">ExeCutive Name</th>
            ...
            $staff_name = getUsernameBycustomerstaffId($order->staff_id);
            @endphp
            ...
            @endphp
                    ...
                    <a href="{{ route('customer_ledger.index') }}?customer_id={{$order->user_id}}" target="_blank" title="{{ translate('View') }}">{{ $customer_id }} </a>
                        ...
                        <td>{{ !empty($staff_name)? $staff_name: 'N/A' }}</td>
