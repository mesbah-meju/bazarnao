...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class=" align-items-center">
        <h1 class="h3 float-left">{{translate('Product wise stock report')}}</h1>
        <a href="{{ route('cutomerservice_add_product.index')}}" class="btn btn-info float-right">Add Product</a>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 mx-auto">
        <div class="card">
            <!--card body-->
            <div class="card-body">
                <form action="{{ route('staff_product') }}" method="GET">
