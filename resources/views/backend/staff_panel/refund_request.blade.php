                    ...
                    <tr>
                        ...
                        @if($refund->refund_status == 0)
                            ...
                            @if($refund->refund_status == 3)
                                ...
                                onclick="delivered_refund_request_modal('{{ $refund->id }}', '{{ $refund->refund_qty }}', '{{ $refund->refund_amount }}')" 
                ...
                <form class="form-horizontal member-block" action="{{ route('delivered_refund_request') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="return_qty" id="return_qty" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="return_amount_balance" id="return_amount_balance" readonly>
                            </div>
                        </div>

                        <!-- Optional: You can re-enable this if you pass balance dynamically -->
                        <!--
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="customer_balance" id="customer_balance" readonly>
                            </div>
                        </div>
                        -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="return_amount" id="return_amount" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="return_remark" id="return_remark">
                            </div>
                        </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function delivered_refund_request_modal(id, qty, amount) {
            $('#delivered_refund_id').val(id);
            $('#return_qty').val(qty);
            $('#return_amount_balance').val(amount);
