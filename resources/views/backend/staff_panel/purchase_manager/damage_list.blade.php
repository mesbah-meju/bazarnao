...
@section('content')
    <div class="row gutters-10">
        <div class="col-lg-12">
            ...
            <div class="card-body">
            <form id="culexpo" action="{{ route('damage_list.index') }}" method="GET">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="end_date" class="form-control" value="{{$end_date}}">
                            ...
                            <div class="col-md-3 mt-4">
                                <button class="btn btn-primary" onclick="submitForm ('{{ route('damage_list.index') }}')">{{ translate('Filter') }}</button>
                            </div>
                        </div>
                    </form>
                    <table class="table table-bordered">
                            ...
                            <tbody id="activity_table">
                                    ...
                                    <tr id="row_{{$key+1}}">
                                        ...
                                        <a onclick="return confirm('Are you sure?')" href="{{route('damage_approve.index', $row->id)}}" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="{{ translate('Approve') }}">
