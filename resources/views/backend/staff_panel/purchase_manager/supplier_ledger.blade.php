...
<div class="col-md-12 mx-auto">
    <div class="card">
        <div class="card-body">
            <form id="culexpo" action="{{ route('supplier_ledger_for_purchase_manager.index') }}" method="get">
                <div class="row">
                ...
                <div class="col-md-3"> 
                    ...
                    <button class="btn btn-sm btn-primary" onclick="submitForm ('{{ route('supplier_ledger_for_purchase_manager.index') }}')">{{ translate('Filter') }}</button>
