                        ...
                        <div class="row card-body">
                            ...
                            <div class="col-md-9">
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        <th style="width:30%">Total Purchase Product Qty: </th>
                                        <td style="width:25%">{{ $data['total_purchase_qty'] }}</td>
                                        <th style="width:30%">Vendor Create: </th>
                                        <td style="width:30%">{{ $data['new_supplier'] }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th style="width:20%">Damage Product QTY : </th>
                                        <td style="width:20%">{{ $data['damage_product_qty'] }}</td>
                                        <th style="width:20%">Performance: </th>
                                        <td style="width:20%">{{ $data['performance'] }}</td>
                                    </tr>
                                    <tr>
