                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="debtAccVoucher">
                            ...
                            <tbody id="debitvoucher">
                                <tr>
                                    <td class="" width="300">
                                        <select name="supplier_id" id="supplier_id_1" class="form-control aiz-selectpicker" data-live-search="true" onchange="load_supplier_code(this.value,1)" required>
                                                <option value="">Select Supplier</option>
                                                @foreach ($suppliers as $suplier)
                                                <option value="{{ $suplier->supplier_id }}"> {{ $suplier->name }}</option>
                                                @endforeach
                                        </select>
                                    </td>
                                    <td>
