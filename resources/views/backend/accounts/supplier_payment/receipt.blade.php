                ...
                <div bgcolor='#e4e4e4' text='#ff6633' link='#666666' vlink='#666666' alink='#ff6633' class="phdiv">
                    <div style="width: 33.33333333%;float: right;">
                        ...
                        <div style="margin-bottom: 15px!important;">
                            ...
                            <abbr class="font-bold"><?php echo translate('Invoice Iime') ?>:</abbr>
                        ...
                        <address style="margin-top: 10px;" class="">
                            <strong class=""><?php echo $supplier_info[0]['name']?> </strong><br>
                            ...
                            <br>
                            <?php } ?>
                            <?php if ($supplier_info[0]['email']) { ?>
                            <abbr style="font-weight: bold;"><?php echo translate('Email') ?>: </abbr>
                            <?php echo $supplier_info[0]['email'];?>
                            <br>
                            <?php } ?>
                        </address>
                    ...
                    <tr>
                        <td>
                            ...
                            Powered By: <a href="javascript:void(0)"><?php echo '4axiz IT Ltd.'?></a>
                        </td>
                    </tr>
                </div>
            </div>
