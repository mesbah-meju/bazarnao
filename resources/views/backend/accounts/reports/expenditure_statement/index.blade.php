            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="dtpFromDate" id="dtpFromDate" class="form-control datepicker" value="{{ date('m/1/Y') }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="dtpToDate" class="form-label">{{ translate('To Date') }}</label>
                        <input type="text" name="dtpToDate" id="dtpToDate" class="form-control datepicker" value="{{ date('m/t/Y') }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
    ...
    <div class="card-body printArea">
        <div class="row pb-3 voucher-center">
            ...
            <div class="col-md-6 text-center">
                <h2>Bazarnao</h2>
                <strong><u class="pt-4">{{ translate('Expenditure Statement Voucher') }}</u></strong>
            </div>
            <div class="col-md-3">
