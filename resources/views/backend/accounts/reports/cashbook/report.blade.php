                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="cmbCode" id="cmbCode" class="form-control aiz-selectpicker" data-live-search="true" required>
                            ...
                            <option value="{{ $cash->head_code }}" {{ (isset($cmbCode) && $cmbCode == $cash->head_code) ? 'selected' : '' }}>{{ $cash->head_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
    ...
    <div class="card-body printArea">
        <div class="row pb-3 voucher-center">
            ...
            <div class="col-md-6 text-center">
                <h2>Bazarnao</h2>
                <strong><u class="pt-4">{{ translate('Cash Book Report') }}</u></strong>
                <br>
...
<script type="text/javascript">
    function printDiv() {
        ...
        printWindow.document.write('<html><head><title>Cash Book Report</title>');
    ...
    function downloadExcel() {
        ...
        var url = '{{ route("cash-book-report.index") }}?type=excel';
