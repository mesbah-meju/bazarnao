...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{ translate('Edit Bank') }}</h5>
</div>
            ...
            <div class="card-body p-0">
                <form class="p-4" action="{{ route('banks.update', $bank->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="ac_name" id="ac_name" class="form-control" value="{{ $bank->ac_name }}">
                    </div>
                    <div class="form-group mb-3">
                        <label for="ac_number" class="form-label">{{ translate('A/C Number') }}</label>
                        <input type="text" name="ac_number" id="ac_number" class="form-control" value="{{ $bank->ac_number }}">
                    </div>
