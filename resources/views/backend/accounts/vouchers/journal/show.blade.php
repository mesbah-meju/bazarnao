...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
        ...
        <div class="col-md-6 text-md-right">
            <a href="{{ route('journal-vouchers.print', $journal->id) }}" target="_blank" class="btn btn-circle btn-info">
        ...
        <div class="col-md-12" id="vaucherPrintArea">
                    ...
                    <table class="print-font-size" width="100%">
                        <tr>
                            ...
                            <td align=" right" style="border-bottom: 2px #333 solid;" width="33.333%">
                                ...
                                {{ date('d/m/Y', strtotime($journal->voucher_date)) }}
                            </td>
                        </tr>
                    </table>
                </caption>
                <caption class="text-center">
                    <h6><strong><u class="pt-4">Journal Voucher</u></strong></h6>
                </caption>
            </table>
            <table class="table table-bordered table-sm mt-2">
                ...
                <tbody>
                    ...
                    @php
                        $total_debit += ($voucher->debit ? $voucher->debit : 0) + ($voucher->credit ? $voucher->credit : 0);
                        $total_credit += ($voucher->debit ? $voucher->debit : 0) + ($voucher->credit ? $voucher->credit : 0);
                    @endphp
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <strong style="font-size: 15px;">{{ $voucher->rev_coa->head_name }}</strong><br>
                            <span>{{ $voucher->ledger_comment }}</span>
                        </td>
                        <td class="text-right">{{ $voucher->credit }}</td>
                        <td class="text-right">{{ $voucher->debit }}</td>
                ...
                <tfoot>
                    ...
                    <tr>
                        <th class="" colspan="3"><?php echo translate('remark') ?> : <?php echo $journal->narration; ?></th>
                    </tr>
                </tfoot>
            </table>
        </div>
