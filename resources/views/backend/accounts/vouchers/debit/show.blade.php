...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
        ...
        <div class="col-md-6 text-md-right">
            <a href="{{ route('debit-vouchers.print', $debit->id) }}" target="_blank" class="btn btn-circle btn-info">
        ...
        <div class="col-md-12" id="vaucherPrintArea">
                    ...
                    <table class="print-font-size" width="100%">
                        <tr>
                            ...
                            <td align=" right" style="border-bottom: 2px #333 solid;" width="33.333%">
                                ...
                                {{ date('d/m/Y', strtotime($debit->voucher_date)) }}
                            </td>
                        </tr>
                    </table>
                </caption>
                <caption class="text-center">
                    <h6><strong><u class="pt-4">Debit Voucher</u></strong></h6>
                </caption>
            </table>
            <table class="table table-bordered table-sm mt-2">
                ...
                <tbody>
                    ...
                    <td>
                        <strong style="font-size: 15px;">
                            {{ $voucher->coa->head_name . ($voucher->sub_type != 1 ? '(' . $voucher->subcode->name . ')' : '') }}
                        </strong><br>
                    ...
                    @endif
                    <tr>
                        <td class="text-left"><strong style="font-size: 15px;">{{ $debit->rev_coa->head_name }}</strong></td>
                ...
                <tfoot>
                    ...
                    <tr>
                        <th class="" colspan="3"><?php echo translate('remark') ?> : <?php echo $debit->narration; ?></th>
                    </tr>
                </tfoot>
            </table>
        </div>
