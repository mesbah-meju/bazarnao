...
<ul class="nav nav-tabs">
	<li class="nav-item">
	  <a class="nav-link active" aria-current="page" href="{{ route('uploaded-invoice.index') }}">Purchase Invoice</a>
	</li>
	<li class="nav-item">
		<a class="nav-link " aria-current="page" href="{{ route('uploaded-sales-invoice.index') }}">Sales Invoice</a>
	</li>
	<li class="nav-item">
		<a target="_blank" href="https://bazarnao.shop/drive/drive" class="btn btn-success">
			<span>{{translate('Show Drive Upload System')}}</span>
		</a>
	</li>
...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		<div class="col-md-6">
			<h1 class="h3">{{translate('All Purchase uploaded Invoice')}}</h1>
		</div>
		{{-- <div class="col-md-3 text-md-right">
			
			<a href="https://bazarnao.shop/drive/drive" class="btn btn-success">
				<span>{{translate('Show Drive Upload System')}}</span>
			</a>
		</div> --}}
		<div class="col-md-6 text-md-right">
			
			<a href="{{ route('uploaded-invoice.create') }}" class="btn btn-primary">
				<span>{{translate('Upload New Purchase Invoice')}}</span>
			</a>
		</div>
	</div>
</div>
...
<div class="card">
    <form id="sort_uploads" action="">
        <div class="card-header row gutters-5">
            <div class="col-md-3">
                <h5 class="mb-0 h6">{{translate('All Purchase Invoice')}}</h5>
            </div>
    				...
    				<div class="aiz-file-box">
    					<div class="dropdown-file" >
    						...
    						<div class="dropdown-menu dropdown-menu-right">
    							...
    							<a href="javascript:void(0)" class="dropdown-item confirm-alert" data-href="{{ route('uploaded-invoice.destroy', $file->id ) }}" data-target="#delete-modal">
...
@section('script')
	<script type="text/javascript">
		function detailsInfo(e){
			...
			$.post('{{ route('uploaded-invoice.info') }}', {_token: AIZ.data.csrf, id:id}, function(data){
