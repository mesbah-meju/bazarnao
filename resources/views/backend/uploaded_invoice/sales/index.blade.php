...
<ul class="nav nav-tabs">
	<li class="nav-item">
	  <a class="nav-link" aria-current="page" href="{{ route('uploaded-invoice.index') }}">Purchase Invoice</a>
	</li>
	<li class="nav-item">
		<a class="nav-link active " aria-current="page" href="{{ route('uploaded-sales-invoice.index') }}">Sales Invoice</a>
	</li>
...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		<div class="col-md-6">
			<h1 class="h3">{{translate('All Sales uploaded Invoice')}}</h1>
		</div>
		<div class="col-md-6 text-md-right">
			<a href="{{ route('uploaded-sales-invoice.create') }}" class="btn btn-primary">
				<span>{{ translate('Upload New Sales Invoice') }}</span>
			</a>
...
<div class="card">
    <form id="sort_uploads" action="">
        <div class="card-header row gutters-5">
            <div class="col-md-3">
                <h5 class="mb-0 h6">{{translate('All Sales Invoice')}}</h5>
            </div>
