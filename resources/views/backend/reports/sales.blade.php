        ...
        <table class="table-sm table-striped table-hover table-bordered" style="width:100%">
            ...
            <tbody>
                ...
                @foreach ($orders as $key => $order)
                    @php
                        $refund_amount = App\Models\RefundRequest::where('order_id', $order->id)
                        ...
                        $totalpaid += $paid - $refund_amount;
                        $due = $order->grand_total - $paid;
                        $totaldue += $due;
                        $total += $order->grand_total - $refund_amount;
                        $i++;
                    @endphp
                    <tr>
                        ...
                        <td class="text-right">{{ single_price($order->grand_total -$refund_amount) }}</td>
                        <td class="text-right">{{ single_price($paid - $refund_amount) }}</td>
