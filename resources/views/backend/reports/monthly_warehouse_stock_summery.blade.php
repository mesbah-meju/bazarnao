...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="align-items-center">
        <h1 class="h3">{{ translate('Monthly Warehouse Stock Summary Report for the Year ') }} {{ $year }}</h1>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 mx-auto">
        <div class="card">
            <div class="card-body">
                <form id="prowasales" action="{{ route('monthly_warehouse_stock_summery.index', ['year' => $year]) }}" method="get">
                ...
                <div class="printArea">
                    ...
                    <h5>{{ translate('Month') }}:<span  class="btn btn-sm btn-success">{{ \Carbon\Carbon::create()->month($month)->format('F') }}</span> </h5>
