...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class=" align-items-center">
        <h1 class="h3">{{translate('Month & Year waise Sales Report Last Three Year Report')}}</h1>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 mx-auto">
        <div class="card">
            <div class="card-body">
                <form id="prowasales" action="{{ route('multiple_product_history_compared_report.index') }}" method="get">
                ...
                @foreach($productsData as $productData)
                    <div class="container mt-4">
                        <h5>Month & Year waise Sales Report Last Three Year Report</h2>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @for ($year = $currentYear; $year >= $currentYear - 2; $year--)
                                        ...
                                        <td>{{ number_format($monthData[$year]['amount'], 2, '.', ',') }}</td>
                                    @endfor
                                </tr>
                                @endforeach
                                <tr>
                                    ...
                                    @for ($year = $currentYear; $year >= $currentYear - 2; $year--)
                                        ...
                                        <td style="text-align:right;"><b>{{ $productData['totals'][$year]['amount'] }}</b></td>
                                    @endfor
                                </tr>
                            </tbody>
                        </table>
