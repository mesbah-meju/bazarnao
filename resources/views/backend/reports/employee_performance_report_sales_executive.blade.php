...
<div class="card">
    <form id="culexpo" class="" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col text-center text-md-left">
                <h5 class="mb-md-0 h6">{{ translate('Sales Executive') }}</h5>
            </div>
    ...
    <input type="date" name="end_date" class="form-control" value="{{ $end_date }}"> --}}
            ...
            <div class="col-md-3">
                ...
                @foreach(\App\Models\Staff::where('role_id', 9)->get() as $executive) 
    ...
    <div class="card-body printArea">
        ...
        <h3 style="text-align:center;">{{translate('Sales Executive Performence Reports')}}</h3>
            ...
            <tbody>
               ...
               @foreach($targets as $key => $target)
                ...
                ?>
                    ...
                    <td class='text-right'>
                    {{ $target->role_name ? $target->role_name: '' }}
                    </td>
                    ...
                    ?>
                    {{ isset($target->customer_achivement) ? number_format($target->customer_achivement,2) : '0'}}%
                    </td>
