...
<div class="card">
    <form id="culexpo" class="" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col text-center text-md-left">
                <h5 class="mb-md-0 h6">{{ translate('Purchase Executive') }}</h5>
            </div>
    ...
    <div class="card-body printArea">
        ...
        <h3 style="text-align:center;">{{translate('Purchase Executive Performence Reports')}}</h3>
        <table class="table table-bordered" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class='text-right'>
                        {{number_format($delivery->total_purchase_amount,2)}}
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        {{ number_format($total_purchase_amount_count,2) }}
                    </td>
