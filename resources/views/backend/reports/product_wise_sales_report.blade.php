...
<div class="row">
    <div class="col-md-12 mx-auto">
        <div class="card">
            <div class="card-body">
                <form id="prowasales" action="{{ route('product_wise_sales_report.index') }}" method="get">
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <br>
                            <div class="d-flex">
                                <button class="btn btn-sm btn-primary" onclick="submitForm('{{ route('product_wise_sales_report.index') }}')">{{ translate('Filter') }}</button>
                                <button class="btn btn-sm btn-info mx-2" onclick="printDiv()" type="button">{{ translate('Print') }}</button>
                                <button class="btn btn-sm btn-success" onclick="submitForm('{{ route('product_wise_sales_report.index', 'excel') }}', 'excel')">Excel</button>
                            </div>
                        </div>
                    </div>
                </form>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    ...
                                    <a href="{{route('number_of_invoice',[
...
<script>
    ...
    function submitForm(url, exportType = null) {
        $('#prowasales').attr('action', url);
        if (exportType) {
            $('#export').val(exportType);
        }
        $('#prowasales').submit();
    }
</script>
