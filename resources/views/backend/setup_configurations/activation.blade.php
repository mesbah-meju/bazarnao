...
<div class="row">
    ...
    <!-- <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <label class="aiz-switch aiz-switch-success mb-0">
                    <input type="checkbox" onchange="updateSettings(this, 'guest_checkout_active')" <?php if(\App\Models\BusinessSetting::where('type', 'guest_checkout_active')->first()->value == 1) echo "checked";?>>
                    <span class="slider round"></span>
                </label>
            </div>
        </div>
