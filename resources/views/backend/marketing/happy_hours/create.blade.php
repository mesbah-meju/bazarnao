...
<div class="row">
    <div class="col-lg-10 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('happy_hours.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <span class="small text-muted">{{ translate('This image is shown as cover banner in happy hour details page.') }}</span>
                        </div>
                    </div>
                    <!-- <div class="form-group row">
                        <label class="col-sm-3 control-label" for="discount_percent">{{translate('Discount Percentage')}}</label>
                        <div class="col-sm-9">
                            <input type="number" placeholder="{{translate('discount percent')}}" id="discount_percent" name="discount_percent" class="form-control" required>
                        </div>
                    </div> -->
                    <div class="form-group row">
        ...
        $(document).ready(function(){
            $('#products').on('change', function(){
                ...
                if(product_ids.length > 0){
                    $.post('{{ route('happy_hours.product_discount') }}', {_token:'{{ csrf_token() }}', product_ids:product_ids}, function(data){
