        ...
        <div class="card">
            <div class="card-body p-0">
              ...
              <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" placeholder="{{translate('discount percent')}}" id="discount_percent" name="discount_percent" class="form-control" value="{{ $flash_deal->discount_percent }}" required>
                        </div>
                    </div>
