...
<div class="form-group row">
   <label class="col-lg-3 col-from-label">{{translate('How many times can use ?')}}</label>
   <div class="col-lg-9">
      <input type="number" lang="en" min="1" step="1" placeholder="{{translate('How many times can use ?')}}" name="max_times" class="form-control" required value="{{ $coupon->max_times }}" >
   </div>
</div>
@php
