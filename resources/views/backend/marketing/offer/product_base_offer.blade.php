<div class="card-header mb-2">
    <h3 class="h6">{{translate('Add Your Product Base Offer')}}</h3>
</div>
...
<div class="form-group row">
   ...
   <div class="col-lg-9">
      <select class="form-control" name="full_discount">
		<option value="1">Full Discount</option>
		<option value="0">Partial Discount</option>
	  </select>
   </div>
</div>
<div class="form-group row">
...
<div class="form-group row">
   ...
   <div class="col-lg-9">
      <input type="number" name="disc_per_qty" class="form-control">
   </div>
</div>
<div class="form-group row">
