            ...
            <div class="col-6">
                <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                    <div class="px-3 pt-3">
                        ...
                        <div class="h3 fw-700 mb-3">{{\App\Models\OrderDetail::where('delivery_status','delivered')->groupBy('order_id')->get()->count()}}</div>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                        <path fill="rgba(255,255,255,0.3)" fill-opacity="1" d="M0,128L34.3,112C68.6,96,137,64,206,96C274.3,128,343,224,411,250.7C480,277,549,235,617,213.3C685.7,192,754,192,823,181.3C891.4,171,960,149,1029,117.3C1097.1,85,1166,43,1234,58.7C1302.9,75,1371,149,1406,186.7L1440,224L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path>
                    </svg>
    ...
    <div class="col-lg-6">
        <div class="row gutters-10">
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h6 class="mb-0 fs-14">{{ translate('Warehouse') }}</h6>
                    </div>
                    <div class="card-body">
...
<div class="col-8">
    <div class="card">
        <div class="card-header">
            <h6 class="mb-0">{{ translate('Top 20 Products (Stock Quantity & Value)') }}</h6>
        </div>
        <table class="table table-striped">
            ...
            <tbody>
                ...
                ?>
                    ...
                    @forelse ($top20Products as $key => $product)
                        @php          
                    ...
                    <tr style="font-weight:bold;">
                        ...
                        <td style="text-align:right;">{{ single_price($total, 2) }}</td>
                    </tr>
                    @endif
            </tbody>
        </table>
...
<script type="text/javascript">
    AIZ.plugins.chart('#pie-1',{
        ...
        data: {
            ...
            datasets: [
                {
                    data: [
                        {{ \App\Models\Product::where('published', 1)->get()->count() }},
                        {{ \App\Models\Product::where('published', 1)->where('added_by', 'seller')->get()->count() }},
                        {{ \App\Models\Product::where('published', 1)->where('added_by', 'admin')->get()->count() }}
                    ],
                    backgroundColor: [
                        "#fd3995",
                        "#34bfa3",
    ...
    AIZ.plugins.chart('#pie-2',{
        ...
        data: {
            labels: [
                '{{translate('Total warehouse')}}',
                '{{translate('Total approved warehouse')}}',
                '{{translate('Total pending warehouse')}}'
            ],
            datasets: [
                {
                    data: [
                        {{ \App\Models\Seller::where('verification_status', 1)->get()->count() }},
