    					...
    					<div class="card-body">
    						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    							...
    							<div class="form-group">
    			                    <label class="form-label" for="signinSrEmail">{{ translate('Footer Logo English') }}</label>
    							...
    							<div class="form-group">
    			                    <label class="form-label" for="signinSrEmail">{{ translate('Footer Logo Bangla') }}</label>
    			                    <div class="input-group " data-toggle="aizuploader" data-type="image">
    			                        <div class="input-group-prepend">
    			                            <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse') }}</div>
    			                        </div>
    			                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
    									<input type="hidden" name="types[]" value="footer_logo_bangla">
    			                        <input type="hidden" name="footer_logo_bangla" class="selected-files" value="{{ get_setting('footer_logo_bangla') }}">
    			                    </div>
    								<div class="file-preview"></div>
    			                </div>
    			                <div class="form-group">
    								<label>{{ translate('About description English') }}</label>
    			                ...
    			                <div class="form-group">
    								<label>{{ translate('About description Bangla') }}</label>
    								<input type="hidden" name="types[]" value="about_us_description_bangla">
    								<textarea class="aiz-text-editor form-control" name="about_us_description_bangla" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]' placeholder="Type.." data-min-height="150">
                                        @php echo get_setting('about_us_description_bangla'); @endphp
                                    </textarea>
    							</div>
                    ...
                    <div class="card shadow-none bg-light">
    					...
    					<div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
    								<label>{{ translate('Bkash Number') }}</label>
    								<input type="hidden" name="types[]" value="bkash_no">
    								<input type="text" class="form-control" placeholder="{{ translate('Bkash NUmber') }}" name="bkash_no" value="{{ get_setting('bkash_no') }}">
    							</div>
								<div class="form-group">
    								<label>{{ translate('Nagad Number') }}</label>
    								<input type="hidden" name="types[]" value="nagad_no">
    								<input type="text" class="form-control" placeholder="{{ translate('Nagad Number') }}" name="nagad_no" value="{{ get_setting('nagad_no') }}">
    							</div>
