                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                        <label style="opacity: 70%;">Date Of Birth</label><br>
                                            <input type="date" class="form-control{{ $errors->has('birth') ? ' is-invalid' : '' }}" value="{{ old('birth') }}" placeholder="" name="birth">
                                        ...
                                        <div class="mb-3">
                                            <label class="aiz-checkbox">
                                                ...
                                                <span class=opacity-60>By signing up you agree to our <a target="_blank" href="{{ route('terms') }}"> terms and conditions </a></span>
