            ...
            <div class="aiz-user-panel">
                ...
                <div class="row gutters-5">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-3 col-md-4 col-sm-6" id="wishlist_{{ $wishlist->id }}">
                        <form id="option-choice-form_{{ $wishlist->product->id }}">
                            @csrf
                            ...
                            <div class="card mb-2 shadow-sm">
                                <div class="card-body">
                                    ...
                                    <div class=" fs-14">
                                        @if(main_home_base_price($wishlist->product->id) != main_home_discounted_base_price($wishlist->product->id))
                                        <del class="opacity-60 mr-1">{{ main_home_base_price($wishlist->product->id) }}</del>
                                        @endif
                                        <span class="fw-600 text-primary">{{ main_home_discounted_base_price($wishlist->product->id) }}</span>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    ...
                                    <button type="button" style="width:100%" class="btn btn-primary buy-now fw-600 add-to-cart" onclick="directAdd({{ $wishlist->product->id  }})">
