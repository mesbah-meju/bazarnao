                ...
                <div class="row gutters-10">
                    <div class="col-md-4">
                        <div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="h3 fw-700">{{ $cart_count }} {{ translate('Product(s)') }}</div>
                    ...
                    <div class="col-md-4">
                        <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="h3 fw-700">{{ $wishlist_count }} {{ translate('Product(s)') }}</div>
                    ...
                    <div class="col-md-4">
                        <div class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="h3 fw-700">{{ $ordered_products_count }} {{ translate('Product(s)') }}</div>
                            ...
                            <div class="card-body">
                                @if($default_address)
                                    <ul class="list-unstyled mb-0">
                                        <li class="py-2"><span>{{ translate('Address') }}: {{ $default_address->address }}</span></li>
                                        <li class="py-2"><span>{{ translate('Country') }}: {{ $default_address->country }}</span></li>
                                        <li class="py-2"><span>{{ translate('City') }}: {{ $default_address->city }}</span></li>
                                        <li class="py-2"><span>{{ translate('Postal Code') }}: {{ $default_address->postal_code }}</span></li>
                                        <li class="py-2"><span>{{ translate('Phone') }}: {{ $default_address->phone }}</span></li>
                                    </ul>
                                @else
                                    <p class="text-muted">{{ translate('No default address found.') }}</p>
                                @endif
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body text-center">
                                    @if($customer_package)
                                        ...
                                        <p class="text-muted mb-4">
                                            {{ translate('Product Upload Remaining') }}: {{ Auth::user()->remaining_uploads }} {{ translate('Times') }}
                                        </p>
                                        <h5 class="fw-600 mb-3 text-primary">
                                    ...
                                    @endif
                                    <a href="{{ route('customer_packages_list_show') }}" class="btn btn-success d-inline-block">
