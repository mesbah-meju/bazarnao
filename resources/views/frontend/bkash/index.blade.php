...
//        			 setTimeout(function(){ //checking by query api after 30 second

//                  $.ajax({
//           			url: '{{ route('bkash.query_payment') }}',
//           			type: 'POST',
//           			contentType: 'application/json',
//           			data: JSON.stringify({
//            			 "paymentID": paymentID
...
//                       //  alert('This is from query payment');
//               		 		 window.location.href = "{{ route('bkash.success') }}?payment_details="+data; //Merchant’s success page
//                         }
//                     	else {
//                			 AIZ.plugins.notify('warning', '<b>Payment Failed !! Please try again.</b><br/>'+result.errorMessage);
