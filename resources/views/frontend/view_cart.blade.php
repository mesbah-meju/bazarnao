                ...
                <div class="row aiz-steps arrow-divider">
                    ...
                    <div class="col">
                        <div class="text-center">
                            ...
                            <h3 class="fs-14 fw-600 d-none d-lg-block opacity-50 text-capitalize">{{ translate('2. Shipping & Payment')}}</h3>
                        </div>
                    </div>
                    <div class="col">
                        <div class="text-center">
                                        ...
                                        <div class="row gutters-5">
                                            <div class="col-lg-5 d-flex">
                                                ...
                                                @if ($product->is_group_product)
                                                    <ul class="list-unstyled ml-2">
                                                        @foreach ($product->group_product as $item)
                                                            <li class="fs-14 opacity-60">{{ $item->product->name }}</li>
                                                            <li class="fs-14 opacity-60">Qty: ({{ $item->qty}})</li> 
                                                        @endforeach
                                                    </ul>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-lg col-6 order-4 order-lg-0">
                                                <div class="row no-gutters align-items-center aiz-plus-minus mr-2 ml-0">
                                                    ...
                                                    <input type="text" name="quantity[{{ $key }}]" class="col border-0 text-center flex-grow-1 fs-16 input-number" placeholder="1" value="{{ $cartItem['quantity'] }}" min="1" max="1000" readonly onchange="updateQuantity({{ $key }}, this)">
