                ...
                <div class="col-xl-3">
                    ...
                    <div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                        ...
                        <div class="collapse-sidebar c-scrollbar-light text-left">
                            ...
                            <div class="bg-white shadow-sm rounded mb-3">
                                ...
                                <div class="p-3">
                                    <div class="aiz-range-slider">
                                        <div id="input-slider-range" data-range-value-min="@if(count(\App\Models\Product::query()->get()) < 1) 0 @else {{ filter_products(\App\Models\Product::query())->get()->min('unit_price') }} @endif" data-range-value-max="@if(count(\App\Models\Product::query()->get()) < 1) 0 @else {{ filter_products(\App\Models\Product::query())->get()->max('unit_price') }} @endif"></div>
                                ...
                                <div class="p-3">
                                    <div class="aiz-radio-inline">
                                        ...
                                        <label class="aiz-megabox pl-0 mr-2" data-toggle="tooltip" data-title="{{ \App\Models\Color::where('code', $color)->first()->name }}">
                                            <input type="radio" name="color" value="{{ $color }}" onchange="filter()" @if(isset($selected_color) && $selected_color==$color) checked @endif>
                            ...
                            <div class="bg-white shadow-sm rounded mb-3">
                                <div class="fs-15 fw-600 p-3 border-bottom">
                                    {{ translate('Filter by') }} {{ \App\Models\Attribute::find($attribute['id'])->getTranslation('name') }}
                                </div>
                                <div class="p-3">
                                    <div class="aiz-checkbox-list">
                                        ...
                                        <label class="aiz-checkbox">
                                            <input type="checkbox" name="attribute_{{ $attribute['id'] }}[]" value="{{ $value }}" @if ($flag) checked @endif onchange="filter()">
                            ...
                            <div class="col mb-3">
                                <div class="aiz-card-box h-100 border border-light rounded shadow-sm hov-shadow-md has-transition bg-white">
                                    ...
                                    <div class="p-md-3 p-2 text-left">
                                        ...
                                        @endif
                                        <div class="mt-3">
                                            <button type="button" style="width:100%;padding:5px 10px" class="btn btn-primary buy-now fw-600 add-to-cart" onclick="directAdd({{ $product->id }})">
