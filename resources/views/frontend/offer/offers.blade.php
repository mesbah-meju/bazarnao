    ...
    <div class="container sm-px-0">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div id="discounted_products" class="row gutters-5 row-cols-xxl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2">
                            ...
                            <div class="aiz-card-box h-100 border border-light rounded shadow-sm hov-shadow-md has-transition bg-white">
                                <div class="position-relative">
                                    ...
                                    <div class="absolute-top-right aiz-p-hov-icon">
                                        @php 
                                            $wishlist_id = checkWishlist($product->id); 
                                        @endphp
                                        @if($wishlist_id)
                                        <a href="javascript:void(0)" onclick="removeFromWishlist({{ $wishlist_id }}, {{ $product->id }})" class="wishlist active" data-toggle="tooltip" data-title="{{ translate('Remove from wishlist') }}" data-placement="left">
                                            <i class="la la-heart-o"></i>
                                        </a>
                                        @else
                                        <a href="javascript:void(0)" onclick="addToWishList({{ $product->id }})" class="wishlist inactive" data-toggle="tooltip" data-title="{{ translate('Add to wishlist') }}" data-placement="left">
                                            <i class="la la-heart-o"></i>
                                        </a>
                                        @endif
                                ...
                                <div class="p-md-3 p-2 text-center product_text_blog">
                                    ...
                                    <div class="mt-3 product_button_block">
                                        ...
                                        <div id="pro_cart_in_{{$product->id}}" style="display: {{$showt}};">
                                            ...
                                            <button type="button" onclick="updateQuantityAdd({{ $pkey }}, {{$procartqty}}, {{ $product->id }})" style="width:65%;padding:5px 10px;border-radius: 0;" class="btn btn-primary buy-now fw-600 add-to-cart">
                                                <i class="las la-shopping-cart"></i>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $.post('{{ route('offer.section.group_product') }}', {_token:'{{ csrf_token() }}'}, function(data){
