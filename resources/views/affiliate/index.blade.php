...
@section('content')
    ...
    <div class="card">
                <div class="card-header">
                    <h6 class="mb-0 h6">{{ translate('Referral System :: Download APP and Registration')}}</h6>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('affiliate.store') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="col-lg-12">
                                <label class="control-label">{{ translate('Referrer User Amount')}}</label>
                            </div>
                            <div class="col-lg-12">
                                @php
                                    if(\App\Models\AffiliateOption::where('type', 'download_app')->first() != null){
                                        $percentage = \App\Models\AffiliateOption::where('type', 'download_app')->first()->percentage;
                            			$discount1 = json_decode(\App\Models\AffiliateOption::where('type', 'download_app')->first()->details)->discount1;
                            			$discount2 = json_decode(\App\Models\AffiliateOption::where('type', 'download_app')->first()->details)->discount2;
                            			$discount3 = json_decode(\App\Models\AffiliateOption::where('type', 'download_app')->first()->details)->discount3;
                                ...
                                @endphp
                                <input type="number" min="0" step="0.01" max="100" class="form-control" name="percentage" value="{{ $percentage }}" placeholder="Enter Amount to referrer User" required>
                            </div>
                        <div class="clearfix"></div>
                        </div>
                        <div class="col-md-6">
                         <div class="col-lg-12">
                                <label class="control-label">{{ translate('Registered User Discount')}}</label>
                            </div>
                            <div class="col-lg-12">
                               <div class="col-lg-4">
                                <label class="control-label">{{ translate('1st Purchase')}}</label>
                            </div>
                            <div class="col-lg-8">
                                <input type="number" min="0" step="0.01" max="100" class="form-control" name="discount1" value="{{ $discount1 }}" placeholder="Enter Amount to registered User 1st puurchase discount" required>
                            </div>
                            <div class="clearfix"></div>
                            </div>
                         <div class="col-lg-12">
                              <div class="col-lg-4">
                                <label class="control-label">{{ translate('2nd Purchase')}}</label>
                            </div>
                            <div class="col-lg-8">
                              <input type="number" min="0" step="0.01" max="100" class="form-control" name="discount2" value="{{ $discount2 }}" placeholder="Enter Amount to registered User 2nd purchase discount" required>
                            </div>
                         <div class="clearfix"></div>
                        </div>
                         <div class="col-lg-12">
                              <div class="col-lg-4">
                                <label class="control-label">{{ translate('3rd Purchase')}}</label>
                            </div>
                            <div class="col-lg-8">
                              <input type="number" min="0" step="0.01" max="100" class="form-control" name="discount3" value="{{ $discount3 }}" placeholder="Enter Amount to registered User 3rd purchase discount" required>
                            </div>
                         <div class="clearfix"></div>
                        </div>
