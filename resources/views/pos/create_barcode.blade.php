                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="search-box input-group">
                                            <button type="button" class="btn btn-secondary btn-lg"><i class="las la-barcode"></i></button>
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <strong><input type="checkbox" name="promo_price"/> Promotional Price</strong>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                        ...
                        <div class="form-group mb-0">
                            <input class="form-control form-control-lg" type="text" id="barcode" name="keyword" placeholder="{{ translate('Barcode') }}">
                        </div>
                    </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    @foreach($lims_product_list_without_variant as $product)
        <?php
            $productArray[] = htmlspecialchars($product->code);
        ?>
    @endforeach
