                              ...
                              <div class="form-box bg-white mt-4">
                                  <div class="form-box-content p-3">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" class="form-control mb-3" id="product_price" name="name" placeholder="{{translate('Product Price')}}" value="{{ $order_detail->price/$order_detail->quantity }}" readonly>
                                        </div>
                                      </div>
                                      <div class="row">
                                          <div class="col-md-3">
                                      ...
                                      <div class="row">
                                        <div class="col-md-3">
                                            <label>{{translate('Refund Quantity')}} <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-md-9">
                                            <input type="number" class="form-control mb-3" min="0" max="{{ $order_detail->quantity }}" id="refund_quantity" name="refund_quantity">
                                        </div>
                                    </div>

                                        <div class="row">
                                            <div class="col-md-3">
                                                <label>{{translate('Refund Amount')}} <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-md-9">
                                                <input type="number" class="form-control mb-3" id="refund_amount" name="refund_amount" readonly>
                                            </div>
                                        </div>
                                      <div class="row">
                                          <div class="col-md-3">
...
<script type="text/javascript">
    document.getElementById('refund_quantity').addEventListener('input', function() {
        const productPrice = parseFloat(document.getElementById('product_price').value) || 0;
        const refundQuantity = parseFloat(this.value) || 0;
        const refundAmount = productPrice * refundQuantity;
