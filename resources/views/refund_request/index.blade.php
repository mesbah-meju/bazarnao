                ...
                @foreach($refunds as $key => $refund)
                    <tr>
                        ...
                        <td class="text-right d-flex align-items-center">
                            ...
                            <a class="btn btn-soft-danger btn-icon btn-circle btn-sm mr-2" onclick="reject_refund('{{ route('reject_reason_show', $refund->id )}}', '{{$refund->id}}', '{{ $refund->order->code }}')"  title="{{ translate('Reject Refund Request') }}">
