...
<head>
    ...
    <?php if(App\Models\BusinessSetting::where('type', 'google_analytics')->first()->value == 1): ?>
    ...
    <?php if(App\Models\BusinessSetting::where('type', 'facebook_pixel')->first()->value == 1): ?>
    <!-- Facebook Pixel Code -->
    <script>
...
<body>
    ...
    <div class="aiz-main-wrapper d-flex flex-column">
        ...
        <?php echo $__env->make('frontend.inc.leftsidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div id="right_side_carts">
            <?php echo $__env->make('frontend.inc.rightsidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        ...
        <div class="modal-dialog modal-dialog-zoom">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php if(App\Models\BusinessSetting::where('type', 'google_login')->first()->value == 1 || App\Models\BusinessSetting::where('type', 'facebook_login')->first()->value == 1 || App\Models\BusinessSetting::where('type', 'twitter_login')->first()->value == 1): ?>
                    ...
                    <?php endif; ?>
                    <?php if(App\Models\BusinessSetting::where('type', 'guest_checkout_active')->first()->value == 1): ?>
                    <div class="separator mb-3">
    ...
    <script>
        ...
        function updateNavCart() {
            ...
            $.post('<?php echo e(route("cart.updateRightCart")); ?>', {
                _token: AIZ.data.csrf
            },
            function(data) {
        ...
        function addToCompare(id) {
            $.post('<?php echo e(route("compare.addToCompare")); ?>', {
                _token: AIZ.data.csrf,
                id: id
            },
            function(data) {
        ...
        function addToWishList(id) {
            <?php if(Auth::check() && (Auth::user()->user_type == 'customer' || Auth::user()->user_type == 'seller')): ?>
                $.post('<?php echo e(route("wishlists.store")); ?>', {
                    _token: AIZ.data.csrf,
                    id: id
                },
                function(data) {
                    if (data != 0) {
                        ...
                        $('#option-choice-form_' + id + ' .aiz-p-hov-icon a.wishlist').attr('data-title', '<?php echo e(translate("Remove from wishlist")); ?>');
                        $('#option-choice-form_' + id + ' .aiz-p-hov-icon a.wishlist').attr('data-original-title', '<?php echo e(translate("Remove from wishlist")); ?>');
        ...
        function removeFromWishlist(id, pid) {
            $.post('<?php echo e(route("wishlists.remove")); ?>', {
            ...
            function(data) {
                ...
                $('#option-choice-form_' + pid + ' .aiz-p-hov-icon a.wishlist').attr('data-title', '<?php echo e(translate("Add to wishlist")); ?>');
                $('#option-choice-form_' + pid + ' .aiz-p-hov-icon a.wishlist').attr('data-original-title', '<?php echo e(translate("Add to wishlist")); ?>');
...
</html><?php /**PATH D:\xampp\htdocs\bazarnao\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>