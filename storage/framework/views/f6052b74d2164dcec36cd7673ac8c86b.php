...
<!-- END Top Bar -->
<header style="background: #dba9c9 !important;" class="<?php if(get_setting('header_stikcy') == 'on'): ?> sticky-top <?php endif; ?> z-1020 bg-white border-bottom shadow-sm d-none d-lg-block">
                ...
                <div class="col-auto col-xl-2 pl-0 pr-3 d-flex align-items-center">
                    <ul class="list-inline mt-3 social colored text-center">
                        ...
                        <li class="list-inline-item">
                            <div class="d-flex">
                            <a href="<?php echo e(route('contact.emergency_contact')); ?>" alt="Emergency Contacts"  target="_blank" class="">
                                <img src="<?php echo e(static_asset('assets/img/emergency.png')); ?>" alt="Emergency Contact" class=" h-30px">
                            </a>
                            <p style="font-size:6px; color:#fff;">Emergency <br>Contact</p>
                        </div>
                        </li>
                    </ul>
                    <a class="" href="<?php echo e(route('home')); ?>" style="padding:10px;">
                        <?php
                        ...
                        <img src="<?php echo e(static_asset('assets/img/logo.png')); ?>" alt="<?php echo e(env('APP_NAME')); ?>" class="mw-100 h-30px h-md-<?php echo e($header_height); ?>px" height="<?php echo e($header_height); ?>">
                   ...
                   <?php if(get_setting('show_language_switcher') == 'on'): ?>
                           ...
                           ?>
                               ...
                               <?php $__currentLoopData = App\Models\Language::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                   ...
                                   <a data-flag="<?php echo e($language->code); ?>" class="lang-change <?php if($locale == $language->code): ?> active-lang <?php endif; ?>">
...
<header class="<?php if(get_setting('header_stikcy') == 'on'): ?> sticky-top <?php endif; ?> z-1020 bg-white border-bottom shadow-sm d-block d-lg-none">
    <div class="position-relative logo-bar-area z-1">
        <div class="container-fluid">
            <div class="d-flex align-items-center">
...
<i style="font-size: 35px;font-weight: bold;color:#AF3C87;" class="las la-list-ul la-2x d-inline-block nav-box-icon"></i>
                ...
                <div class="col-auto  pl-0 pr-0 d-flex align-items-center" style="width: 50%;">
                    <a class="" href="<?php echo e(route('home')); ?>" style="padding:0px 0px 10px 15px;">
                        <?php
                        if($locale=='en'){
                        $header_logo = get_setting('header_logo');
                        $header_height = '45';
                        ...
                        ?>
                        <?php if($header_logo != null): ?>
                        <img src="<?php echo e(uploaded_asset($header_logo)); ?>" alt="<?php echo e(env('APP_NAME')); ?>" class="mw-100 h-40px h-md-<?php echo e($header_height); ?>px" height="<?php echo e($header_height); ?>">
                        <?php else: ?>
                        <img src="<?php echo e(static_asset('assets/img/logo.png')); ?>" alt="<?php echo e(env('APP_NAME')); ?>" class="mw-100 h-50px h-md-<?php echo e($header_height); ?>px" height="<?php echo e($header_height); ?>">
                        <?php endif; ?>
                    </a>
                    ...
                    <div class="flex-grow-1">
                        <form action="" method="GET" class="stop-propagation">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="input-group">
                                    <input type="text" class="border-0 border-lg form-control" id="searchm" name="q" placeholder="<?php echo e(translate('I am shopping for...')); ?>" autocomplete="off">
                                    <div class="input-group-append d-none d-lg-block">
                                        <button class="btn btn-primary" type="submit">
                                            <i class="la la-search la-flip-horizontal fs-18"></i>
                                        </button>
    ...
    <?php endif; ?>
</header><?php /**PATH D:\xampp\htdocs\bazarnao\resources\views/frontend/inc/nav.blade.php ENDPATH**/ ?>