...
class DownloadsalesReportModel implements FromCollection, WithMapping, WithHeadings
{
    ...
    public function collection()
    {
        ...
        if (!empty($sort_user_id)) {
            $orders = $orders->join('customers', 'customers.user_id', '=', 'orders.user_id')
    ...
    public function map($orders): array
    {
        ...
        if(!empty(\App\Models\Customer::where('user_id', $orders->user_id)->first())){
            $customer_id = \App\Models\Customer::where('user_id', $orders->user_id)->first();
