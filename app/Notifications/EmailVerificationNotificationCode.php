...
class EmailVerificationNotificationCode extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
       // $notifiable->verification_code = encrypt($notifiable->id);
        ...
        $array['content'] = 'Please provide this verification code from below to verify your email address. Code is : '.$notifiable->verification_code;
