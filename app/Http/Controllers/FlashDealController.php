...
class FlashDealController extends Controller
{
    ...
    { 
        ...
        $flash_deal->discount_percent = $request->discount_percent;
        $flash_deal->status = 1;
        if($flash_deal->save()){
            foreach ($request->products as $key => $product) {
                ...
                $flash_deal_product->web_quantity = $web_quantity;
                $flash_deal_product->app_quantity = $app_quantity;
                $flash_deal_product->product_id = $product;
                $flash_deal_product->discount = $request->discount_percent;
