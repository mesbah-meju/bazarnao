...
class AffiliateController extends Controller
{
    ...
    public function affiliate_option_store(Request $request){
        ...
        }elseif ($request->type == 'download_app') {
            $commision_details['discount1'] = $request->discount1;
            $commision_details['discount2'] = $request->discount2;
        $commision_details['discount3'] = $request->discount3;
        $affiliate_option->percentage = $request->percentage;
        }
    ...
    public function user_index(){
        ...
        return view('affiliate.frontend.index', compact('affiliate_logs'));
    }
