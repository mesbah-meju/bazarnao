...
class CouponController extends Controller
{
    public function apply(Request $request)
    {
        ...
        if ($coupon != null && strtotime(date('d-m-Y')) >= $coupon->start_date && strtotime(date('d-m-Y')) <= $coupon->end_date && CouponUsage::where('user_id', $request->user_id)->where('coupon_id', $coupon->id)->count() < $coupon->max_times) {
