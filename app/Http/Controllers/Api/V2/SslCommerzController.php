...
class SslCommerzController extends Controller
{
    ...
    {
        $sandbox = BusinessSetting::where('type', 'sslcommerz_sandbox')->first()->value;

        $this->setSSLCommerzMode($sandbox ? 1 : 0);
    ...
    public function begin(Request $request)
    {
        ...
        $order = Order::where('id', $request->order_id)->first(); // Assuming you want to fetch one order
        ...
        $post_data['cus_email'] = $shipping_address->email;
    ...
    public function payment_success(Request $request)
    {
        ...
        if (isset($request->value_c)) {
            ...
            try {
                ...
                return response()->json(['result' => true, 'message' => "Payment is successful",'order_id'=>$order_id]);
            } catch (\Exception $e) {
